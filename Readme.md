...
* [ ] Implement AST/Line Classifier
* [ ] Build pure-source Transformer
* [ ] Create CLI Wrapper and LCOV Exporter

The old runtime-coupled implementation (`Coverage` singleton, `SceneTree` monitoring, GUT hook scripts, JSON coverage merging) has been removed as part of this migration. If you're looking for that version, see the [original upstream project](https://github.com/jamie-pate/godot-code-coverage?utm_source=gemini) or an earlier commit in this repo's history.
